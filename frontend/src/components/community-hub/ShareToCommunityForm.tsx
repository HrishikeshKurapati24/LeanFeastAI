...
export default function ShareToCommunityForm({
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5 md:space-y-6">
            ...
            {/* AI Generated Toggle */}
            <div className="flex items-center gap-2 sm:gap-2.5 md:gap-3 p-3 sm:p-3.5 md:p-4 bg-neutral-50 rounded-lg sm:rounded-xl">
                <input
                    type="checkbox"
                    id="ai-generated"
                ...
                />
                <label htmlFor="ai-generated" className="text-xs sm:text-sm font-semibold text-neutral-42 cursor-pointer">
                    Generated by AI
                </label>
            </div>
            ...
            >
                {loading ? "Posting to Community... 🍽️" : "Post to Community 🍽️"}
            </button>
        </form>
    );
}