...
interface SavedMealsState extends EntityState<UserRecipe, string> {
    meta: SavedMealsMeta;
}

const initialState: SavedMealsState = savedMealsAdapter.getInitialState({
    meta: {
        currentPage: 0,
        pageSize: 20,
        hasMore: false,
